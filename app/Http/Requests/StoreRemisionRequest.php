...
class StoreRemisionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            // Datos generales
            'numero' => ['required', 'string', 'max:20', 'unique:remisiones'],
    ...
    {
        return [
            'numero.required' => 'El número de remisión es obligatorio.',
            'numero.unique' => 'Ya existe una remisión con este número.',
            ...
            'fecha.required' => 'La fecha de la remisión es obligatoria.',
            'fecha.date' => 'Debe ingresar una fecha válida.',
            'detalles.required' => 'Debe agregar al menos un detalle a la remisión.',
            'detalles.min' => 'La remisión debe tener al menos un producto.',
