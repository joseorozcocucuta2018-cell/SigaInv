        ...
        <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:1rem;">
            ...
            <x-filament::section>
                <div style="text-align:center;">
                    ...
                    <p class="text-2xl font-bold text-gray-950 dark:text-white">${{ number_format($totales['total_subtotal'], 0, ',', '.') }}</p>
                </div>
            </x-filament::section>
            <x-filament::section>
                <div style="text-align:center;">
                    <p class="text-sm text-gray-500 dark:text-gray-400">Impuesto</p>
                    <p class="text-2xl font-bold text-gray-950 dark:text-white">${{ number_format($totales['total_impuesto'], 0, ',', '.') }}</p>
                </div>
            </x-filament::section>
            <x-filament::section>
                <div style="text-align:center;">
